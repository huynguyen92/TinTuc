...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	private static final String KEY_NEWSSOURCE = "newssource";
	...
	// Creating Tables
			...
			public	void AddtoFavorite(Pojo pj)
			{
				...
				values.put(KEY_NEWSSOURCE, pj.getNewSource());
			...
			public List<Pojo> getAllData() 
			{
				...
				if (cursor.moveToFirst()) 
				{
					do {
						...
						contact.setnId(cursor.getString(1));
						...
						contact.setNewSource(cursor.getString(7));
		...
		//getting single row
			...
			public Pojo getFavRow(String id)
			{
				// Select All Query
		...
		//for remove favorite
			...
			public void RemoveFav(String idnew)
			{
			    SQLiteDatabase db = this.getWritableDatabase();
